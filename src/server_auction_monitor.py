...
# 配置过滤条件
CPU = os.getenv("SB_CPU")
RAM = os.getenv("SB_RAM")
LOCATION = os.getenv("SB_LOCATION")
TRAFFIC = os.getenv("SB_TRAFFIC")
PRICE = float(os.getenv("SB_PRICE"))
LIVE_DATA_JSON = os.getenv("LIVE_DATA_SB_JSON")
# 通知头
SEND_TITLE = "Hetzner - 拍卖独服监控"
